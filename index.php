    ...
    <div class="container-fluid">
      ...
      <div class="col-sm-12">
        ...
        foreach ($hasil as $data){
          ...
          // Konversi bulan dalam bahasa Indonesia
        $bulanIndonesia = [
          'Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli',
          'Agustus', 'September', 'Oktober', 'November', 'Desember'
      ];
      $birthDate = date_create($data['tanggal_lahir']);
      ...
      echo '<td class="text-center">' . $data['tempat_lahir'] . ', ' . $tanggalLahir . '</td>';
        ...
        <tr>
            ...
            <th colspan="4" class="text-center" ><span><?php echo count($hasil) ?>
                </th>
              </tr>
            </table>
          </div>
